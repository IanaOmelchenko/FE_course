...
// Вам необходимо реализовать смену темы с темной на светлую и наоборот. 
// Тема должна переключаться при нажатии на кнопку “Tab”. Изначально тема светлая.
...
document.addEventListener('keydown', (event) => {
    ...
    // const lightThedarkThemeOmeOn = body.style.background = 'initial';
    if(key === 'Tab' && lightThemeOn){
       console.log(isLightBackground);
      body.style.background = '#24292E';
    //   taskItems.style.color = '#ffffff';
    //   allBtns.style.border = '5px solid #ffffff';
    }
    else if(key === 'Tab' && body.style.background === '#24292E'){
      body.style.background = 'initial';
    //   taskItems.style.color = 'initial';
    //   allBtns.style.border = 'none';
    }
})
